...
public class Studer_2_1 extends PApplet {


 //This allows us to use serial objects
...
public void input(String theText) {
  ...
  int tty = PApplet.parseInt(theText);
...
public void controlEvent(ControlEvent theEvent) {
  if (theEvent.getName()=="spd") { 
    int windi  = PApplet.parseInt(wind);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Studer_2_1" };
    if (passedArgs != null) {
